...
import { MusicIcon } from '@/shared/icons/CustomIcons';
...
export const MusicAdsTab: React.FC = () => {
    ...
    const { musicFile, musicSetFile, musicSetAdInfo, musicSetCallToAction, musicSetBudgetReach, resetMusicAds } = useAdsUploadStore();
    ...
    const handleNext = () => {
        if (flow === 1) {
            ...
            // Save Flow 2 data
            musicSetCallToAction({ action: callToAction as any, link: actionLink });
            musicSetBudgetReach({
    ...
    const handlePublish = async () => {
        try {
            ...
            toast.success('Campaign created', 'Your music ad campaign has been submitted for review');
        } catch (error) {
                ...
                <Flex gap={5} direction={{ base: 'column', lg: 'row' }}>
                    ...
                    <Box w={{ base: 'full', lg: '400px' }} bg="gray.100" borderRadius="lg" p={4}>
                        ...
                        {musicFile && (
                            <Box>
                                <audio
                                    src={musicFile.url || (musicFile.file ? URL.createObjectURL(musicFile.file) : '')}
                                    controls
            ...
            <Box flex="1">
                <VStack align="stretch" gap={5}>
                    ...
                    <FileUploadArea
                        ...
                        title="Upload Music Ad"
                        supportedFormats="Support MP3, WAV, AAC"
                        Icon={MusicIcon}
                        fileType="audio"
                    />
