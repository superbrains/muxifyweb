...
/** Dedicated management page for the Ad Managers role (CR1 per-role separation). */
const AdManagersPage: React.FC = () => {
    const c = useRoleUsers('ad_manager');

    return (
        <AdminPageLayout
            title={`${meta.plural} Management`}
            subtitle="Manage ad managers and their advertising campaigns"
