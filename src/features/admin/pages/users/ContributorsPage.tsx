...
/** Dedicated management page for the Contributors role (CR1 per-role separation). */
const ContributorsPage: React.FC = () => {
    const c = useRoleUsers('contributor');

    return (
        <AdminPageLayout
            title={`${meta.plural} Management`}
            subtitle="Browse, verify and manage every contributor on the platform"
