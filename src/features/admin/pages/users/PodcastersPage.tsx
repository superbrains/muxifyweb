...
/** Dedicated management page for the Podcasters role (CR1 per-role separation). */
const PodcastersPage: React.FC = () => {
    const c = useRoleUsers('podcaster');

    return (
        <AdminPageLayout
            title={`${meta.plural} Management`}
            subtitle="Browse, verify and manage every podcaster on the platform"
