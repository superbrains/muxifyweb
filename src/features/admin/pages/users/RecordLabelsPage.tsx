...
/** Dedicated management page for the Record Labels role (CR1 per-role separation). */
const RecordLabelsPage: React.FC = () => {
    const c = useRoleUsers('record_label');

    return (
        <AdminPageLayout
            title={`${meta.plural} Management`}
            subtitle="Manage record labels and their rosters"
