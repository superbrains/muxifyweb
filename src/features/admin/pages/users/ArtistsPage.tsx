...
/** Dedicated management page for the Artists role (CR1 per-role separation). */
const ArtistsPage: React.FC = () => {
    const c = useRoleUsers('artist');

    return (
        <AdminPageLayout
            title={`${meta.plural} Management`}
            subtitle="Browse, verify and manage every artist on the platform"
