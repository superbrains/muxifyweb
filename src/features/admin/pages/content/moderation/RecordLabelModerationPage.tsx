...
/** Per-role moderation queue for record-label-owned content (CR1 separation). */
const RecordLabelModerationPage: React.FC = () => (
    <AdminPageLayout
...
export default RecordLabelModerationPage;
