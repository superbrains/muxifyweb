...
/** Per-role moderation queue for contributor-owned content (CR1 separation). */
const ContributorModerationPage: React.FC = () => (
    <AdminPageLayout
...
export default ContributorModerationPage;
