...
export const AdManagerRegistrationForm: React.FC = () => {
    ...
    const [errors, setErrors] = useState<AdManagerRegistrationErrors>({});
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        if (errors[name as keyof AdManagerRegistrationErrors]) {
    ...
    const validateForm = (): boolean => {
        const newErrors: AdManagerRegistrationErrors = {};
