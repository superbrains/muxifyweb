...
interface ContributorRegistrationData {
    name: string;
    email: string;
    phone: string;
    password: string;
...
interface ContributorRegistrationErrors {
    name?: string;
    email?: string;
    phone?: string;
    password?: string;
...
export const ContributorRegistrationForm: React.FC = () => {
    const [formData, setFormData] = useState<ContributorRegistrationData>({
        name: '',
        email: '',
        phone: '',
        password: '',
    ...
    const [errors, setErrors] = useState<ContributorRegistrationErrors>({});
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (errors[name as keyof ContributorRegistrationErrors]) {
    ...
    const validateForm = (): boolean => {
        const newErrors: ContributorRegistrationErrors = {};
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            navigate('/onboarding/contributor/verify-email', {
        ...
        <VStack gap={4} align="center">
            <Box textAlign="center">
                <Text fontSize="lg" fontWeight="semibold" color="black" mb={1}>
                    Producers, Songwriters & Contributors
                </Text>
                <Text fontSize="xs" color="gray.600" mb={4}>
                    Create your contributor account to get credited on releases and earn
                ...
                <Stack gap={3}>
                    ...
                    <Box>
                        ...
                        <Input
                            ...
                            placeholder="How you’re credited (e.g. Sarz)"
